...
urlpatterns = [
    ...
    path('afp/<str:no_afp>/', sdn_views.sdn_afp_delete),
    path('ars/', sdn_views.sdn_ars),
    path('ars/<str:no_ars>/', sdn_views.sdn_ars_delete),
    path('gerencias/', sdn_views.sdn_gerencias),
    path('gerencias/<str:no_gerencia>/', sdn_views.sdn_gerencia_delete),
    path('areas/', sdn_views.sdn_areas),
    path('areas/<str:no_gerencia>/<str:no_area>/', sdn_views.sdn_area_delete),
    path('deptos/', sdn_views.sdn_deptos),
    path('deptos/<str:no_gerencia>/<str:no_area>/<str:no_depto>/',
         sdn_views.sdn_depto_delete),
    path('ingresos/', sdn_views.sdn_ingresos),
    path('deducciones/', sdn_views.sdn_deducciones),
    path('empleados/', sdn_views.sdn_empleados),
    path('empleados/catalogos/', sdn_views.sdn_empleado_catalogos),
    path('empleados/<str:no_cia>/<int:no_empleado>/', sdn_views.sdn_empleado),
    path('empleados/<str:no_cia>/<int:no_empleado>/baja/', sdn_views.sdn_empleado_baja),
    path('empleados/<str:no_cia>/<int:no_empleado>/reactivar/', sdn_views.sdn_empleado_reactivar),
    ...
    path('nominas/resumen-cierre/', sdn_views.sdn_nomina_resumen_cierre),
    path('nominas/cerrar/', sdn_views.sdn_nomina_cerrar),
