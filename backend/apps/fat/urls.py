...
from .views import (
    ...
    FatMotivosAnulacionView, FatCajeroPendientesView, FatCobrarFacturaView,
    ...
    FatRepVentasView, FatRep607View, FatArchivoDgii607View, FatRepNcfNulosView, FatRepFacturasRncView,
...
urlpatterns = [
    ...
    path('fat/facturas/cobrar/', FatCobrarFacturaView.as_view()),
    ...
    path('fat/reportes/607/archivo-dgii/', FatArchivoDgii607View.as_view()),
    ...
    path('fat/asientos-generados/', FatAsientosGeneradosView.as_view()),
