  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-screen w-(--sidebar-width) transition-[inset-inline,width] duration-200 ease-linear md:flex',
          side === 'left'
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex min-h-0 flex-1 flex-col gap-2 overflow-auto px-1 py-1 group-data-[collapsible=icon]:overflow-hidden',
        className
      )}
      {...props}
    />
