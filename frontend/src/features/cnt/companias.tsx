...
interface Cia {
  ...
  cuenta_itbis_retenido: string | null
}

function f(val: any): string {
  return val ?? ''
}
...
export function Companias({ noCia }: Props) {
  ...
  const loadList = () =>
    regalGeneralApi.cntCias().then((d) => setCias(d as Cia[]))
  ...
  const handleSave = async () => {
    ...
    try {
      await regalGeneralApi.cntUpdateCia(form.no_cia, {
        ...
        activa: form.activa,
        tasa_us: form.tasa_us,
        itbis: form.itbis,
        utilidad_retenida: form.utilidad_retenida,
        cuenta_isr: form.cuenta_isr,
  ...
  const handleCreate = async () => {
    ...
    if (!no_cia.trim() || !descripcion.trim()) {
      toast.error('No Cia y Nombre son requeridos')
      return
    }
    setCreating(true)
    try {
      await regalGeneralApi.cntCreateCia({
        no_cia: no_cia.trim(),
        descripcion: descripcion.trim(),
        tasa_us: Number(tasa_us),
        itbis: Number(itbis),
      })
      ...
      {form && !loading && (
        <div className='space-y-4'>
          ...
          <div className='flex items-center gap-4 rounded-lg border bg-muted/30 p-4'>
            <div className='flex h-20 w-32 items-center justify-center overflow-hidden rounded-md border bg-background'>
              {logoUrl ? (
                <img
                  src={logoUrl}
                  alt='Logo'
            ...
            <div className='space-y-2'>
              ...
              <p className='text-xs text-muted-foreground'>
                Aparece en todos los reportes PDF y Excel.
                <br />
          ...
          <div className='flex flex-wrap items-center gap-3'>
            ...
            <Input
              className='w-36'
              placeholder='Tel 1'
              value={f(form.telefono1)}
              onChange={(e) => set('telefono1', e.target.value)}
            />
            <Input
              className='w-36'
              placeholder='Tel 2'
              value={f(form.telefono2)}
          ...
          <div className='flex flex-wrap items-center gap-4'>
            <div className='flex items-center gap-2'>
              <Checkbox
                id='activa'
                checked={form.activa === 'S'}
                onCheckedChange={(v) => set('activa', v ? 'S' : 'N')}
              />
            ...
            <div className='flex items-center gap-2'>
              ...
              <Input
                ...
                value={form.tasa_us ?? ''}
                onChange={(e) =>
                  set('tasa_us', e.target.value ? Number(e.target.value) : null)
                }
              />
            </div>
            <div className='flex items-center gap-2'>
              ...
              <Input
                ...
                value={form.itbis ?? ''}
                onChange={(e) =>
                  set('itbis', e.target.value ? Number(e.target.value) : null)
                }
              />
            </div>
            <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <Input
              ...
              value={f(form.utilidad_retenida)}
              onChange={(e) => set('utilidad_retenida', e.target.value)}
            />
          </div>
          <div className='flex items-center gap-3'>
            ...
            <Input
              className='w-48 font-mono'
              value={f(form.cuenta_isr)}
              onChange={(e) => set('cuenta_isr', e.target.value)}
            />
          </div>
          <div className='flex items-center gap-3'>
            ...
            <Input
              className='w-48 font-mono'
              value={f(form.cuenta_itbis_retenido)}
              onChange={(e) => set('cuenta_itbis_retenido', e.target.value)}
            />
          </div>
          ...
          <div className='space-y-3 py-2'>
            <div className='flex items-center gap-3'>
              ...
              <Input
                ...
                value={newForm.no_cia}
                onChange={(e) =>
                  setNewForm((p) => ({ ...p, no_cia: e.target.value }))
                }
                placeholder='01'
              />
            </div>
            <div className='flex items-center gap-3'>
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewForm((p) => ({ ...p, descripcion: e.target.value }))
                }
            ...
            <div className='flex items-center gap-3'>
              ...
              <Input
                className='w-24'
                type='number'
                value={newForm.tasa_us}
                onChange={(e) =>
                  setNewForm((p) => ({ ...p, tasa_us: e.target.value }))
                }
              />
            </div>
            <div className='flex items-center gap-3'>
              ...
              <Input
                ...
                value={newForm.itbis}
                onChange={(e) =>
                  setNewForm((p) => ({ ...p, itbis: e.target.value }))
                }
              />
            </div>
          </div>
