...
export const registry: Record<string, RegistryEntry> = {
  ...
  'inv-lineas-sublineas': {
    codigo: 'inv-lineas-sublineas', modulo: 'INV', nombre: 'Líneas y Sublíneas', familia: 'reporte',
    printDataPath: (_id, qs) => `/inv/reportes/lineas-sublineas/print-data/?${qs.toString()}`,
    defaultTemplate: reporteGenericoDefault('Líneas y Sublíneas', [
      { campo: 'linea', label: 'Línea', align: 'left' },
      { campo: 'sub_linea', label: 'Sub-línea', align: 'left' },
      { campo: 'descripcion', label: 'Descripción', align: 'left' },
    ]),
    defaultPageSize: 'A4', defaultPageOrientation: 'P',
    variables: ['reporte.titulo', 'reporte.filtros', 'filas[].linea',
      'filas[].sub_linea', 'filas[].descripcion', 'totales.cantidad'],
  },
  'inv-auxiliar': {
    codigo: 'inv-auxiliar', modulo: 'INV', nombre: 'Auxiliar de Inventario', familia: 'reporte',
    printDataPath: (_id, qs) => `/inv/reportes/auxiliar/print-data/?${qs.toString()}`,
    defaultTemplate: reporteGenericoDefault('Auxiliar de Inventario', [
      { campo: 'fecha', label: 'Fecha', align: 'left', format: 'date' },
      { campo: 'tipo_docu', label: 'Tipo', align: 'left' },
      { campo: 'no_docu', label: 'No. Doc.', align: 'left' },
      { campo: 'almacen', label: 'Almacén', align: 'left' },
      ...
      { campo: 'cantidad', label: 'Cantidad', align: 'right' },
      { campo: 'costo', label: 'Costo', align: 'right', format: 'money' },
      { campo: 'monto_neto', label: 'Monto', align: 'right', format: 'money' },
    ], { groupBy: 'no_produ', subtotalCampos: 'cantidad,monto_neto' }),
    defaultPageSize: 'A4', defaultPageOrientation: 'L',
    variables: ['reporte.titulo', 'reporte.filtros', 'filas[].fecha', 'filas[].tipo_docu',
      'filas[].no_docu', 'filas[].almacen', 'filas[].no_produ', 'filas[].descripcion',
      'filas[].tipo_movi', 'filas[].cantidad', 'filas[].costo', 'filas[].monto_neto',
      'totales.cantidad', 'totales.total'],
  },
  'inv-conteo-comparativo': {
    codigo: 'inv-conteo-comparativo', modulo: 'INV', nombre: 'Comparativo de Conteo Físico', familia: 'reporte',
    printDataPath: (_id, qs) => `/inv/reportes/conteo-comparativo/print-data/?${qs.toString()}`,
    defaultTemplate: reporteGenericoDefault('Comparativo de Conteo Físico', [
      { campo: 'almacen', label: 'Almacén', align: 'left' },
      { campo: 'no_produ', label: 'Producto', align: 'left' },
      { campo: 'descripcion', label: 'Descripción', align: 'left' },
      { campo: 'conteo_fisico', label: 'Conteo Físico', align: 'right' },
      { campo: 'exist_libro', label: 'Exist. Libro', align: 'right' },
      { campo: 'diferencia', label: 'Diferencia', align: 'right' },
      { campo: 'costo_actual', label: 'Costo', align: 'right', format: 'money' },
      { campo: 'valor_diferencia', label: 'Valor Dif.', align: 'right', format: 'money' },
    ]),
    defaultPageSize: 'A4', defaultPageOrientation: 'L',
    variables: ['reporte.titulo', 'reporte.filtros', 'filas[].almacen', 'filas[].no_produ',
      'filas[].descripcion', 'filas[].conteo_fisico', 'filas[].exist_libro', 'filas[].diferencia',
      'filas[].costo_actual', 'filas[].valor_diferencia', 'totales.cantidad', 'totales.total'],
  },
